...
export class AIActions {
  public static excludeRejectedLabelNames(
  ...
  public static detect(imageId: string, image: HTMLImageElement): void {
    ...
    const isAIYOLOObjectDetectorModelLoaded =
      AISelector.isAIYOLOObjectDetectorModelLoaded();
    const isAISSDObjectDetectorModelLoaded =
  ...
  public static rejectAllSuggestedLabels(imageData: ImageData) {
    ...
    switch (activeLabelType) {
      case LabelType.RECT:
        ...
        if (isRoboflowAPIModelLoaded) {
          AIRoboflowAPIObjectDetectionActions.rejectAllSuggestedRectLabels(
            imageData
          );
        }
        break;
  ...
  public static acceptAllSuggestedLabels(imageData: ImageData) {
    ...
    switch (activeLabelType) {
      case LabelType.RECT:
        ...
        if (isRoboflowAPIModelLoaded) {
          AIRoboflowAPIObjectDetectionActions.acceptAllSuggestedRectLabels(
            imageData
          );
        }
        break;
